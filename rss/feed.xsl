...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                        ...
                        <div class="profile-card">
                            <div class="avatar-wrapper">
                                <div class="avatar-container">
                                    <img src="/img/avatar.webp" alt="chai" class="avatar" />
                            ...
                            <div class="profile-info">
                                <h1 class="site-title">热爱学习的未来酱</h1>
                                <p class="site-subtitle">嵌入式 Linux 开发工程师</p>
                                <p class="site-bio">专注瑞芯微 RK3588/RK3576 开发 | 系统编程 | 驱动开发 | 技术分享</p>

                                <div class="social-links">
                                                    <a href="https://github.com/chai0705" target="_blank" class="social-btn github" title="Github">
                                                        <i class="ri-github-fill"></i>
                                                    </a>
                                                    <a href="tencent://message/?uin=1361382269&Site=&Menu=yes" target="_blank" class="social-btn qq" title="Qq">
                                                        <i class="ri-qq-fill"></i>
                                                    </a>
                                                    <a href="mailto:1361382269@qq.com" target="_blank" class="social-btn email" title="Email">
    ...
    阅读全文 <i class="ri-arrow-right-s-line"></i>
                    ...
                    <footer class="page-footer">
                        <p>Designed with <i class="ri-heart-3-fill heart-beat"></i> by chai0705</p>
                        <p class="copyright">
