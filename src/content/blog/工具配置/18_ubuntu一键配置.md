---
description: "8| 9|____ 10| 11|> 先说一下心路历程，每次创建一个新的wsl的时候，我都要重新配置一遍，但这样也太费劲了，所以我就打算搞一个一体的脚本，来进行配置，我现在的要求是换源、安装编译需要的软件包，设置python，设置vim 12| 13| 	整合脚本 14| 15|shell 16|!"
