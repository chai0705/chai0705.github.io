---
description: "TF卡烧写目前就这样了，现在来重新分析一下流程。最开始的时候他是需要按update启动的，所以应该从这个地方开始入手，看看为什么按着update按键启动就能进入烧写模式呢？ 首先来到u-boot-2020.01/board/vendor/ss928v100/ss928v100.c目录下，先到更前面把"
