---
description: "工作记录星期四 > 第1章 初步认识I2C > > ​	1.1 PWM基础知识 > > ​		介绍一下  频率周期和占空比  面积等效原理 > > ​	1.2 iTOP-RK3568开发板PWM接口介绍 > > ​		硬件资源、数据手册介绍 三种工作模式，捕获、连续、单次、PWM复用关系图 > >"
