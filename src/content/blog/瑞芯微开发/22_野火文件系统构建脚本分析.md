---
description: "其实野火保持了基本的构建，也就是瑞芯微的那种构建方式，只是因为我认为这种方式并不好所以我很久之前就不用了，而是换成了从github上学来的方式方法，怎么说呢各有个的好处，我还是喜欢我现在的这种方法，但是还欠缺一个合并起来的契机，等下次再说了，现在先学习一下野火的构建方式，学习一下其中的优点，看看我有"
